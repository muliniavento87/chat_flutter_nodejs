...
abstract class $ChatStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<String> msgs, String? errorMessage, bool loading});
}
...
class _$ChatStateData implements ChatStateData {
  const _$ChatStateData(
      {final List<String> msgs = const [],
      this.errorMessage,
      this.loading = false})
      : _msgs = msgs;
  ...
  @override
  String toString() {
    return 'ChatState(msgs: $msgs, errorMessage: $errorMessage, loading: $loading)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_msgs), errorMessage, loading);
...
abstract class ChatStateData implements ChatState {
  const factory ChatStateData(
      ...
      final String? errorMessage,
      final bool loading}) = _$ChatStateData;
